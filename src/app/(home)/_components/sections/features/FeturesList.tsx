    ...
    return (
        <>
            {featuresList?.map(feature => (
                <Card key={feature.id} className="dark:bg-gnrDark p-0 dark:shadow-gnrWhite/10 border border-gnrPrimary/10 shadow-xs hover:shadow-xl hover:-translate-y-1.5 rounded-lg transition-global duration-500 group">
