    ...
    return (
        <Div initial="initial" animate="animate" variants={variantsContainerFadeUpComponents} className="flex items-center gap-6 py-4">
            <Div variants={variantsChildrenFadeUp}>
                <Button className="dark:bg-white dark:hover:bg-white/80 dark:text-black md:!px-8 md:py-6 text-white font-semibold shadow-xl bg-gnrPrimary text-lg hover:bg-gnrPrimary/80 hover:scale-105 cursor-pointer transition-global duration-300" asChild>
            ...
            <Div variants={variantsChildrenFadeUp} transition={{duration: 0.8, delay: 0.8}}>
                <Button
                    variant={"outline"}
                    className="dark:bg-transparent dark:text-white dark:border-white/10 md:!px-8 md:py-6 font-semibold shadow-xl bg-transparent text-lg cursor-pointer"
                    asChild
                >
