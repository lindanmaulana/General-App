    ...
    return (
        <Div initial="initial" animate="animate" variants={variantsContainerFadeUpComponents} className="flex items-center gap-6 py-4">
            <Div variants={variantsChildrenFadeUp}>
                <Button className="dark:bg-white dark:hover:bg-white/80 dark:text-black !p-6 md:!px-8 md:py-6 text-white font-semibold shadow-xl bg-gnrPrimary text-lg hover:bg-gnrPrimary/80 hover:scale-105 hover:rotate-6 cursor-pointer transition-global duration-300" asChild>
