...
export const IncomesDocument = ({period, date, data, totalBalance}: IncomesDocumentProps) => {
    const reportDate = handleParseDate(date, "YYYY-MM-DD")
    ...
    const styles = StyleSheet.create({
        ...
        // const totalBalance = handleParsePrice(queryTotalBalance.data)
                    ...
                    <Page size="A4" style={styles.page}>
                        <View style={styles.report_heading}>
                            <View style={styles.report_heading_logo}>
                                ...
                                <Text style={styles.report_heading_logo_text}>General ALhidayah Muncangela</Text>
                            </View>
