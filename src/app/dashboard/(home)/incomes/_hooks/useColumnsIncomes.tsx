...
import { FormUpdate } from "../_components/forms/Update";
import { FormDelete } from "../_components/forms/Delete";
        ...
        const column: ColumnDef<incomes>[] = [
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <span className="text-gnrGreen bg-gnrGreen/20 rounded-full px-2 py-px font-semibold">
                            {nameEvent}
                        </span>
                    );
                },
