            ...
            <PaginationContent>
              <PaginationItem>
                <PaginationPrevious
                  ...
                  className={`${!pagination.prevPage ? 'pointer-events-none opacity-50 cursor-not-allowed' : ''}`}
                >
                  Prev
                </PaginationPrevious>
              </PaginationItem>
              {pagination.links.map((page: number) => {
                ...
                return (
                  <PaginationItem key={page}>
                    <PaginationLink
                      onClick={() => handlePagination(page.toString())}
                      isActive={isActive}
              ...
              <PaginationItem>
                <PaginationNext
                  ...
                  className={`${!pagination.nextPage ? 'pointer-events-none opacity-50 cursor-not-allowed' : ''}`}
                >
                  Next
                </PaginationNext>
              </PaginationItem>
