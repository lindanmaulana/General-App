      ...
      <DialogContent>
        <form onSubmit={handleForm} className="space-y-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Apakah Anda yakin ingin menghapus pengeluaran dari <span className="font-bold text-gnrDark">{data.source}</span> sejumlah <span>{incomeAmount}</span> ? Tindakan ini
