    ...
    return (
        <div className='w-full flex flex-col md:flex-row items-center gap-3'>
            <Label className='relative flex w-full'>
                ...
                <Input id='filter-search' onChange={handleSearch} defaultValue={defaultQueryKeyword} placeholder='Cari sumber pendapatan...' type='text' className='w-full pl-8 font-normal' />
            </Label>
