    ...
    <main>
      <section className="relative bg-cover bg-no-repeat -z-10" style={{backgroundImage: "url('/images/banner/mushola-alhidayah.jpg')"}}>
        ...
        <div className="h-screen container max-w-5xl mx-auto px-4 md:px-0">
            <div className="h-full flex flex-col items-center justify-center gap-3">
              ...
              <h2 className="text-center text-5xl font-bold text-white leading-12">Selamat Datang di <br /> Kampung Alhidayah(General) <br /> <span className="text-gnrPrimary">Desa Muncangela</span></h2>
      ...
      <section className="py-20">
        <div className="container max-w-5xl mx-auto px-4 md:px-0">
          ...
          <section className="grid grid-cols-2 gap-5 py-14">
            <section className="space-y-4">
              <h3 className="text-4xl font-bold leading-12">Membangun Perubahan Berkelanjutan</h3>
      ...
      <section className="py-20 bg-[#f8fafc]">
        <div className="container max-w-5xl mx-auto px-4 md:px-0">
          ...
          <section className="py-20 grid grid-cols-3 gap-7">
