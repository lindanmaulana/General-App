...
export class eventsService {
    ...
    static async update(req: TypeEventsSchema, id: string) {
        ...
        if(result.error) throw new errorApiCustom(`${RESPONSE_MESSAGE.error.update} event`, result.status)
    ...
    static async delete(id: string) {
        ...
        if(result.error) throw new errorApiCustom(`${RESPONSE_MESSAGE.error.delete} event`, result.status)
