...
import { TypeExpensesSchema } from "../validations/expenses";
...
export class expensesService {
    ...
    static async create(req: expensesCreateRequest) {
        ...
        if(result.error) throw new errorApiCustom(`${RESPONSE_MESSAGE.error.create} pengeluaran`, result.status)
    ...
    static async update(req: TypeExpensesSchema, id: string): Promise<expenses> {
        ...
        if(result.error) throw new errorApiCustom(`${RESPONSE_MESSAGE.error.delete} pengeluaran`, result.status)
    ...
    static async getAll(req: NextRequest) {
        ...
        if(req) {
            ...
            if(result.error) throw new errorApiCustom(`${RESPONSE_MESSAGE.error.read} pengeluaran`, result.status)
